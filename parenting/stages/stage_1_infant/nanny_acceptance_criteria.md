...
## Dealbreakers (Immediate Termination)

These behaviors result in same-day termination, no second chances:

1. **Shouting, hitting, or any harsh discipline** toward the baby
2. **Inviting friends or family** to the apartment during work hours
3. **Smoking** (anywhere, including breaks outside — residue on hands/clothes is a risk)
4. **Excessive phone use** while the baby is in her care
5. **Feeding unapproved foods** (sugar, salt, honey, or anything not on the protocol)
6. **Leaving the baby unattended** even briefly (e.g. to go to the lobby, take a call outside)

> These will be stated clearly in the contract and reinforced during onboarding. The nanny should understand them **before** the first trial day.
...
Once a candidate passes, formalize with:
...
- [ ] Social insurance / health check requirements per Vietnamese labor law

---

## Backup Plan

**Always have a #2 candidate warm.** After hiring your top choice:

- [ ] Keep the second-best candidate's contact info
- [ ] Tell the agency you may need a quick replacement
- [ ] If nanny calls in sick: Day 1 = dad remote day. Day 2+ = activate backup or agency temp.

> The whole point of this system is to **never** be one person away from a crisis again.
